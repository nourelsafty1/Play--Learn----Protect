                ...
                {leaderboard.rankings.map((entry, index) => (
                  <div
                    ...
                    className={`flex items-center justify-between p-4 rounded-lg ${
                      index < 3 ? getRankColor(entry.rank) + ' text-white' : 'bg-gray-50'
                    }`}
                  >
                    <div className="flex items-center gap-4 flex-1">
                      ...
                      <div className={`w-12 h-12 rounded-full ${entry.child.avatar || getAvatarColor(entry.child.name)} flex items-center justify-center ${
                        index < 3 ? 'text-white border-2 border-white' : 'text-white'
                      } font-bold`}>
