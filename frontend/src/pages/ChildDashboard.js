      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="bg-gradient-to-br from-green-400 to-teal-500 text-white text-center">
            <div className="text-4xl mb-2">⏰</div>
            <div className="text-5xl font-bold mb-2">{dashboard.screenTime?.today || 0}m</div>
            <div className="text-sm opacity-90">Today's Screen Time</div>
            <div className="text-xs mt-2 opacity-90">
              {dashboard.screenTime?.remaining || 0}m remaining
            </div>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Recent Achievements */}
          <Card title="🏆 Your Achievements" subtitle={`${dashboard.achievements?.length || 0} earned`}>
